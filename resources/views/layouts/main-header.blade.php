                                    ...
                                    <div class="dropdown-menu">
                                        <div class="menu-header-content bg-primary text-right">
                                            <div class="d-flex">
                                                ...
                                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left">
                                                    <a href="/markAllRead" class="text-white">Mark All Read</a> </span>
                                            </div>
                                            <p id="notification_count" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
                                        ...
                                        <div id="unreadNotifications" class="main-notification-list Notification-scroll">
                                            @foreach(auth()->user()->unreadNotifications as $notification)
                                                ...
                                                <a class="d-flex p-3 border-bottom" href="/markRead/{{ $notification->id }}">
