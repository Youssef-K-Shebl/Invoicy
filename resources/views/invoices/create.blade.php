                            ...
                            <div class="col">
                                ...
                                <select id="section_id" name="section_id" class="form-control">
                                    ...
                                    @foreach ($sections as $section)
                                        <option {{ old('section_id') == $section->id ? 'selected' : '' }} value="{{ $section->id }}">{{ $section->section_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Amount_Commission"
                                       value="{{ old('amount_collection') }}" name="amount_commission" title="يرجي ادخال مبلغ العمولة "
