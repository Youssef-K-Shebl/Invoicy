                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                                <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control select2" name="type"
                                    ...
                                    <option {{ isset($type) ? $type == 3 ? 'selected' : '' : ''}} value='3'>الفواتير المدفوعة</option>
                                    <option {{ isset($type) ? $type == 1 ? 'selected' : '' : '' }} value='1'>الفواتير الغير مدفوعة</option>
                                    <option {{ isset($type) ? $type == 2 ? 'selected' : '' : '' }} value='2'>الفواتير المدفوعة جزئيا</option>
